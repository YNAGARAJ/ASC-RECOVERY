...
| B-16 | MEDIUM | `domain/x835.py:462-482` | SVC04 revenue code is parsed then discarded (hardcoded `None`) — also blocks F-17's implant fix until threaded through |
